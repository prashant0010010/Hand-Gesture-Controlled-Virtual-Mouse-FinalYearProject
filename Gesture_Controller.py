...
class Controller:
    ...
    def handle_controls(gesture, hand_result):  
        ...
        if gesture == Gest.V_GEST:
            ...
            Controller.flag = False
            with open("detected_gestures.txt", "w") as file:
                file.write("Left: Left Click")

        elif gesture == Gest.INDEX and Controller.flag:
            pyautogui.click(button='right')
            Controller.flag = False
            with open("detected_gestures.txt", "w") as file:
                file.write("Right: Right Click")

        elif gesture == Gest.TWO_FINGER_CLOSED and Controller.flag:
            pyautogui.doubleClick()
            Controller.flag = False
            with open("detected_gestures.txt", "w") as file:
                file.write("Index and Middle finger closed: Double Click")
            ...
            with open("detected_gestures.txt", "w") as file:
                file.write("Pinch Major/ changesystembrightness/ changesystemvolume ")
